...
<div id="content">
	<div id="left_col">
		<aui:input label="url" name="urlInputText" readonly="true" type="text" value='<%= "ws://" + request.getServerName() + ":" + request.getServerPort() + "/o/chat" %>' />
		</br>
		...
		<br />
		<aui:input name="message" onkeydown="sendMessage();" type="text" />
